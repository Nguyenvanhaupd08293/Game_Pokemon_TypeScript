...
}`, "",{"version":3,"sources":["webpack://./src/frontend/style.css"],"names":[],"mappings":"AAAA;IACI,sBAAsB;IACtB,kBAAkB;IAClB,iCAAiC;IACjC,aAAa;IACb,gBAAgB;IAChB,qBAAqB;AACzB;;AAEA;IACI,kCAAkC;AACtC","sourcesContent":[".gameItem {\r\n    border: 1px solid #ddd;\r\n    border-radius: 5px;\r\n    box-shadow: 5px 10px 10px #e8f5ee;\r\n    height: 100px;\r\n    overflow: hidden;\r\n    background: #e2e2e2b0;\r\n}\r\n\r\n.unmatched {\r\n    background-color: rgb(232, 79, 79);\r\n}"],"sourceRoot":""}]);
// Exports
...
class GameController {
    ...
    renderGameBoard() {
        this.shuffle();
        let boarDiv = this.element.querySelector('#board');
        if (boarDiv) {
            this.items.forEach(it => this.renderHTML(boarDiv, it));
        }
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkassigment1"] = self["webpackChunkassigment1"] || [];
